...
function Graphs() {
  ...
  return (
    <div>
    {length > 0 ? (<div className="flex justify-around items-center mt-4  bg-gray-100 shadow w-3/4 m-auto rounded">
  ...
  </div>) : (<div className="flex justify-around items-center mt-4  bg-gray-100 shadow w-3/4 m-auto rounded h-24">
    <span className="font-light text-3xl text-gray-700">Add an income or expense to see magic!</span>
  </div>)}
